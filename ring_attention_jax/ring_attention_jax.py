...
This module is designed to be used with JAX and Flax, and it is compatible with TPU.
Ring attention functions are cloned from https://github.com/LargeWorldModel/LWM/blob/main/lwm/ring_attention.py.
"""
